/*
 FinCoach - 数据库清洗与真实 A 股种子数据
 日期: 2026-02-11
 说明: 清空旧数据，注入 80+ 条真实 A 股龙头股数据（含沪深300核心成分股）
       价格初始为 0，由 Python 脚本 real_market_updater.py 自动获取真实行情
*/
...
-- ========================================
-- 2. 真实 A 股种子数据（80 条龙头股）
--    价格初始为 0，Python 脚本会自动更新
-- ========================================
...
-- 完成提示
SELECT CONCAT('✅ 种子数据注入完成！共插入 ', COUNT(*), ' 条记录') AS result FROM market_security;
